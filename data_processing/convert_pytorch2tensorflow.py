...
tf_checkpoint_path =  "./source/pretrain-model/tensorflow/chinese_wobert_L-12_H-768_A-12/bert_model.ckpt"
bert_config_file = "./source/pretrain-model/tensorflow/chinese_wobert_L-12_H-768_A-12/bert_config.json"
pytorch_dump_path = "./source/pretrain-model/pytorch/chinese_wobert_L-12_H-768_A-12/pytorch_model.bin"
